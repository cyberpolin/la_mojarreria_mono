...
`apps/taku-wa-web`, the developer-facing TAKU WhatsApp Bridge UI.

## Vercel Project

Use these settings for the Vercel project:

- Root directory: `apps/taku-wa-web`
- Framework preset: Next.js
- Build command: `pnpm --filter @taku/wa-web build`
...
For local development, `apps/taku-wa-web/.env` should point to the local
WA backend:
...
For production-like local builds, `apps/taku-wa-web/.env.production`
